    ...
    <div className="min-h-screen bg-gray-50 pb-20 md:pb-6">
      <div className="container mx-auto md:p-6 lg:p-8">
        ...
        <div className="text-center mb-6 md:mb-8">
          <h1 className="text-xl md:text-2xl lg:text-3xl font-bold text-gray-800 mb-2 wrap-break-word">
          ...
          <div className="flex flex-col lg:flex-row gap-4 items-start lg:items-center">
            <div className="flex-1 w-full">
              ...
              <select
                ...
                className="w-full h-12 border border-gray-300 rounded-lg px-3 bg-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm md:text-base"
              >
            ...
            {selectedDate !== "" && (
              <div className="w-full lg:w-auto">
                <button
                  ...
                  disabled={updating}
                  className="w-full lg:w-auto bg-blue-500 hover:bg-blue-600 text-white px-6 md:px-8 py-3 rounded-lg transition-colors disabled:opacity-50 font-medium text-sm md:text-base"
                >
                  {updating ? (
                ...
                {materials.rm && materials.rm.length > 0 ? (
                  <div className="space-y-2 md:space-y-3">
                    {materials.rm.map((item) => (
                      ...
                      >
                        <span className="text-gray-700 font-medium flex-1 text-sm md:text-base wrap-break-word pr-2">
                          {item.name.toString()}
                        </span>
                        <div className="flex items-center gap-2 shrink-0">
                          <input
                            ...
                            className="w-20 md:w-24 bg-white border border-gray-300 rounded-lg px-2 md:px-3 py-1 md:py-2 text-right focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm md:text-base"
                            placeholder="0.00"
                            min="0"
                          />
                          <span className="text-gray-500 text-xs md:text-sm w-6 md:w-8">kg</span>
                        </div>
                      </div>
                    ))}
                  </div>
                  ...
                  <div className="text-center py-6 md:py-8">
                    <div className="text-gray-400 text-4xl md:text-6xl mb-2">📦</div>
                    <p className="text-gray-500 text-sm md:text-base">No raw materials available</p>
                  </div>
                )}
              </div>
            </div>
                      ...
                      >
                        ...
                        <div className="flex items-center gap-2 shrink-0">
                          <input
                            ...
                            className="w-20 md:w-24 bg-white border border-gray-300 rounded-lg px-2 md:px-3 py-1 md:py-2 text-right focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent text-sm md:text-base"
                            placeholder="0.00"
                            min="0"
                          />
                          <span className="text-gray-500 text-xs md:text-sm w-6 md:w-8">pcs</span>
                        </div>
                      </div>
                    ))}
                  </div>
        ...
        {/* Empty State */}
        {selectedDate === "" && (
          <div className="bg-white rounded-xl shadow-lg p-6 md:p-8 lg:p-12 text-center">
            ...
            <p className="text-gray-500 text-sm md:text-base lg:text-lg max-w-md mx-auto">
        ...
        {selectedDate !== "" && (
          <div className="lg:hidden fixed bottom-0 left-0 right-0 p-4 bg-white border-t border-gray-200 shadow-lg">
            <button
              onClick={handleChangeSave}
              disabled={updating}
              className="w-full bg-blue-500 hover:bg-blue-600 text-white py-3 rounded-lg transition-colors disabled:opacity-50 font-medium text-base"
            >
              {updating ? (
                <span className="flex items-center gap-2 justify-center">
