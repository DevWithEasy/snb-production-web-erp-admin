      ...
      <div className="space-y-3 md:space-y-4">
        {products.map((product) => (
          <button
            ...
            className="w-full text-left p-4 md:p-5 bg-white rounded-lg border border-gray-200 hover:border-blue-300 hover:shadow-md transition-all duration-200 flex justify-between items-center cursor-pointer active:scale-[0.98]"
          >
...
const EmptyState = () => (
  <div className="text-center py-8 md:py-12 bg-white rounded-lg shadow-sm border border-gray-200">
    <div className="max-w-md mx-auto px-4">
      <DocumentIcon />
      <p className="text-gray-500 text-lg mb-4">No recipes data available</p>
