  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-300">
                    ...
                    >
                      <div className="flex-1">
                        ...
                        <div className="flex items-center space-x-4 ml-12">
                          {material.code && (
                            <span className="px-2 py-1 bg-purple-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-400 text-xs rounded-full font-medium">
                              {material.code}
                            </span>
                          )}
                          {material.type && (
                ...
                !loading && (
                  <div className="text-center py-12">
                    ...
                    <p className="text-gray-400 dark:text-gray-500 text-sm mt-1">
                      Please search for materials or check your section
                      selection
                    </p>
                  </div>
                )
      ...
      <CustomConfirmationModal
        ...
        onConfirm={() =>
          materialToDelete && deleteMaterial(materialToDelete.id)
        }
